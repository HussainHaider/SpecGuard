...
CATALOGUE: tuple[ProductTemplate, ...] = (
    ...
    ProductTemplate(
        ...
        nutrients=Nutrients(
            fat=2.1, saturates=1.1, carbohydrate=5.8, sugars=4.9, fibre=1.1, protein=1.3, salt=0.62
        ),
    ...
    ProductTemplate(
        ...
        nutrients=Nutrients(
            fat=2.4, saturates=0.5, carbohydrate=38.9, sugars=2.6, fibre=6.8, protein=9.4, salt=0.98
        ),
    ...
    ProductTemplate(
        ...
        nutrients=Nutrients(
            fat=0.2, saturates=0.0, carbohydrate=9.1, sugars=8.9, fibre=0.3, protein=0.7, salt=0.01
        ),
    ...
    ProductTemplate(
        ...
        nutrients=Nutrients(
            fat=3.9, saturates=0.6, carbohydrate=6.2, sugars=5.1, fibre=1.6, protein=1.5, salt=0.71
        ),
    ...
    ProductTemplate(
        ...
        nutrients=Nutrients(
            fat=31.2, saturates=3.1, carbohydrate=49.6, sugars=0.6, fibre=4.2, protein=6.1, salt=1.1
        ),
        storage="Store in a cool, dry place.",
        durability_kind="Best before",
    ...
    ProductTemplate(
        ...
        nutrients=Nutrients(
            fat=2.8, saturates=0.9, carbohydrate=4.4, sugars=1.7, fibre=0.9, protein=4.9, salt=0.79
        ),
